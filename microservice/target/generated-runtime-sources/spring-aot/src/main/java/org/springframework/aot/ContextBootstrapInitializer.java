...
import com.example.microservice.config.SpringConfig;
import com.example.microservice.controllers.RequestController;
...
public class ContextBootstrapInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  ...
  public void initialize(GenericApplicationContext context) {
    ...
    BeanDefinitionRegistrar.of("com.example.microservice.MicroserviceApplication", MicroserviceApplication.class)
        .instanceSupplier(MicroserviceApplication::new).register(beanFactory);
    BeanDefinitionRegistrar.of("requestDAO", RequestDAO.class).withConstructor(JdbcTemplate.class)
        .instanceSupplier((instanceContext) -> instanceContext.create(beanFactory, (attributes) -> new RequestDAO(attributes.get(0)))).register(beanFactory);
    BeanDefinitionRegistrar.of("springConfig", SpringConfig.class).withConstructor(ApplicationContext.class)
        .instanceSupplier((instanceContext) -> instanceContext.create(beanFactory, (attributes) -> new SpringConfig(attributes.get(0)))).register(beanFactory);
    BeanDefinitionRegistrar.of("requestController", RequestController.class).withConstructor(RequestDAO.class)
        .instanceSupplier((instanceContext) -> instanceContext.create(beanFactory, (attributes) -> new RequestController(attributes.get(0)))).register(beanFactory);
    BeanDefinitionRegistrar.of("request", Request.class)
        .instanceSupplier(() -> new Request()).register(beanFactory);
    BeanDefinitionRegistrar.of("microserviceApplication", MicroserviceApplication.class)
        .instanceSupplier(MicroserviceApplication::new).register(beanFactory);
    ...
    BeanDefinitionRegistrar.of("org.springframework.web.servlet.config.annotation.DelegatingWebMvcConfiguration", DelegatingWebMvcConfiguration.class)
        .instanceSupplier((instanceContext) -> {
          DelegatingWebMvcConfiguration bean = new DelegatingWebMvcConfiguration();
    ...
    BeanDefinitionRegistrar.of("mvcContentNegotiationManager", ContentNegotiationManager.class).withFactoryMethod(WebMvcConfigurationSupport.class, "mvcContentNegotiationManager")
        .instanceSupplier(() -> beanFactory.getBean(WebMvcConfigurationSupport.class).mvcContentNegotiationManager()).register(beanFactory);
    ...
    BeanDefinitionRegistrar.of("requestMappingHandlerAdapter", RequestMappingHandlerAdapter.class).withFactoryMethod(WebMvcConfigurationSupport.class, "requestMappingHandlerAdapter", ContentNegotiationManager.class, FormattingConversionService.class, Validator.class)
        .instanceSupplier((instanceContext) -> instanceContext.create(beanFactory, (attributes) -> beanFactory.getBean(WebMvcConfigurationSupport.class).requestMappingHandlerAdapter(attributes.get(0), attributes.get(1), attributes.get(2)))).register(beanFactory);
    ...
    BeanDefinitionRegistrar.of("mvcConversionService", FormattingConversionService.class).withFactoryMethod(WebMvcConfigurationSupport.class, "mvcConversionService")
        .instanceSupplier(() -> beanFactory.getBean(WebMvcConfigurationSupport.class).mvcConversionService()).register(beanFactory);
    BeanDefinitionRegistrar.of("mvcValidator", Validator.class).withFactoryMethod(WebMvcConfigurationSupport.class, "mvcValidator")
        .instanceSupplier(() -> beanFactory.getBean(WebMvcConfigurationSupport.class).mvcValidator()).register(beanFactory);
    ...
    BeanDefinitionRegistrar.of("localeResolver", LocaleResolver.class).withFactoryMethod(WebMvcConfigurationSupport.class, "localeResolver")
        .instanceSupplier(() -> beanFactory.getBean(WebMvcConfigurationSupport.class).localeResolver()).register(beanFactory);
    BeanDefinitionRegistrar.of("themeResolver", ThemeResolver.class).withFactoryMethod(WebMvcConfigurationSupport.class, "themeResolver")
        .instanceSupplier(() -> beanFactory.getBean(WebMvcConfigurationSupport.class).themeResolver()).register(beanFactory);
    BeanDefinitionRegistrar.of("flashMapManager", FlashMapManager.class).withFactoryMethod(WebMvcConfigurationSupport.class, "flashMapManager")
        .instanceSupplier(() -> beanFactory.getBean(WebMvcConfigurationSupport.class).flashMapManager()).register(beanFactory);
    ...
    BeanDefinitionRegistrar.of("dataSource", DataSource.class).withFactoryMethod(SpringConfig.class, "dataSource")
        .instanceSupplier(() -> beanFactory.getBean(SpringConfig.class).dataSource()).register(beanFactory);
    BeanDefinitionRegistrar.of("jdbcTemplate", JdbcTemplate.class).withFactoryMethod(SpringConfig.class, "jdbcTemplate")
        .instanceSupplier(() -> beanFactory.getBean(SpringConfig.class).jdbcTemplate()).customize((bd) -> bd.setDependsOn(new String[] { "dataSourceScriptDatabaseInitializer" })).register(beanFactory);
